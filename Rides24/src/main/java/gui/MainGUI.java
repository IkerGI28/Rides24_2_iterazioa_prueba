...
public class MainGUI extends JFrame {
	...
	public MainGUI(/*Driver d*/) {
		...
		//jButtonRegister.setText(ResourceBundle.getBundle("Etiquetas").getString("MainGUI.CreateRide"));
		...
		//jButtonLogIn.setText(ResourceBundle.getBundle("Etiquetas").getString("MainGUI.btnNewButton.text"));
